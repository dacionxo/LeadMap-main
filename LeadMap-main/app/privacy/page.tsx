...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    ...
    const sectionIds = Array.from({ length: 16 }, (_, i) => `section-${i + 1}`)
    ...
    // Also observe the summary section
    const summarySection = document.getElementById('summary')
    if (summarySection) {
      sectionsRef.current['summary'] = summarySection
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* Privacy Policy Content - Apollo.io style container */}
          <div className="max-w-none">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                <strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. Learn more about <a href="#section-2" className="text-primary hover:underline">how we process your information</a>.
              </p>
              <p className="text-gray-700 mb-4">
                <strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. Learn more about <a href="#section-4" className="text-primary hover:underline">when and with whom we share your personal information</a>.
              </p>
              <p className="text-gray-700 mb-4">
                <strong>How do we keep your information safe?</strong> We have adequate organizational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about <a href="#section-9" className="text-primary hover:underline">how we keep your information safe</a>.
              </p>
              <p className="text-gray-700 mb-4">
                <strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about <a href="#section-11" className="text-primary hover:underline">your privacy rights</a>.
              </p>
              <p className="text-gray-700 mb-4">
                <strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a <a href="https://app.termly.io/dsar/a69f9ffd-3e4d-4f51-b007-f779e3e93ee6" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">data subject access request</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
              </p>
              <p className="text-gray-700 mb-4">
                Want to learn more about what we do with any information we collect? <a href="#toc" className="text-primary hover:underline">Review the Privacy Notice in full</a>.
              </p>
            </section>

            {/* Table of Contents */}
            <section id="toc" className="mb-10 p-6 bg-gray-50 rounded-lg border border-gray-200">
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6">1. WHAT INFORMATION DO WE COLLECT?</h2>
              
              <h3 className="text-xl font-semibold text-gray-900 mb-4 mt-6" id="personalinfo">Personal information you disclose to us</h3>
              <p className="text-gray-700 mb-4">
              ...
              <p className="text-gray-700 mb-4">
                <strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by Stripe. You may find their privacy notice link(s) here: <a href="https://stripe.com/privacy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://stripe.com/privacy</a>.
              </p>
              <p className="text-gray-700 mb-4">
                <strong>Social Media Login Data.</strong> We may provide you with the option to register with us using your existing social media account details, like your Facebook, X, or other social media account. If you choose to register in this way, we will collect certain profile information about you from the social media provider, as described in the section called <a href="#section-7" className="text-primary hover:underline">"HOW DO WE HANDLE YOUR SOCIAL LOGINS?"</a> below.
              </p>
              <p className="text-gray-700 mb-4">
                All personal information that you provide to us must be true, complete, and accurate, and you must notify us of any changes to such personal information.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 mb-4 mt-6">Information automatically collected</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4 mt-6">Google API</h3>
              <p className="text-gray-700 mb-4">
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6" id="infouse">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
              <p className="text-gray-700 mb-4">
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6" id="legalbases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
