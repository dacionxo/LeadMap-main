...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700", className)}
      classNames={{
        ...
        cell: "h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-gray-100 dark:bg-gray-800 [&:has([aria-selected])]:bg-gray-100 dark:bg-gray-800 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
        day: cn(
        ...
        day_outside:
          "day-outside text-gray-500 dark:text-gray-400 aria-selected:bg-blue-600 aria-selected:text-white",
