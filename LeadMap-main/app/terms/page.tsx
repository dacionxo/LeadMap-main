...
export default function TermsPage() {
  ...
  useEffect(() => {
    ...
    const sectionIds = Array.from({ length: 27 }, (_, i) => `section-${i + 1}`)
      ...
      <div className="pt-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <p className="text-base text-gray-600 mb-6">Last updated: February 17, 2026</p>
          </div>
          ...
          <div className="max-w-none">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                We are Galapagos Digital LLC, doing business as StackDeal.io (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;), a company registered in Virginia, United States, at __________, 500 E. Main Street, Norfolk, VA 23504.
              </p>
              <p className="text-gray-700 mb-4">
                We operate the website{' '}
                <a href="https://www.stackdeal.io/terms" className="text-primary hover:underline">
                  https://www.stackdeal.io/terms
                </a>{' '}
              ...
              <p className="text-gray-700 mb-4">
                ...
                <a href="mailto:legal@stackdeal.io" className="text-primary hover:underline">
                  legal@stackdeal.io
                </a>{' '}
                or by mail to __________, 500 E. Main Street, Norfolk, VA 23504, United States.
              </p>
              <p className="text-gray-700 mb-4">
                These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;), and Galapagos Digital LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms.{' '}
                <strong>
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6">10. SOCIAL MEDIA</h2>
              <p className="text-gray-700 mb-4">
