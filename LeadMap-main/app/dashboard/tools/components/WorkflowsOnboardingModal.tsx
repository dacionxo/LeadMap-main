...
import { X, BarChart3, Zap, Workflow, GitBranch } from 'lucide-react'

interface WorkflowsOnboardingModalProps {
  isOpen: boolean
  onClose: () => void
  onBeginSetup: () => void
  onMaybeLater: () => void
...
export default function WorkflowsOnboardingModal({
  isOpen,
  onClose,
  onBeginSetup,
  onMaybeLater,
}: WorkflowsOnboardingModalProps) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl mx-4 relative">
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-full p-6 mb-4 relative">
                <div className="bg-white rounded-full p-4">
                  <div className="text-center">
                    <Workflow className="w-8 h-8 text-green-600 mx-auto" />
                    <div className="text-xs text-gray-600 mt-2">Workflows active</div>
                  </div>
                </div>
                {/* Decorative stars */}
                ...
                <div className="absolute -bottom-2 -left-2 w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center">
                  <GitBranch className="w-4 h-4 text-yellow-800" />
                </div>
              </div>
        ...
        <div className="p-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Build powerful automation workflows to streamline your sales process. Connect your tools, automate repetitive tasks, and focus on what matters most—closing deals.
          </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  Create multi-step workflows to automate your entire sales process
                </span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="flex-shrink-0 mt-0.5 text-blue-600 dark:text-blue-400">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  Build complex multi-branch workflows with conditional logic and triggers
                </span>
              </li>
            </ul>
          </div>
