...
import { X, BarChart3, Zap, TrendingUp, Target } from 'lucide-react'
...
export default function AnalyticsOnboardingModal({
  isOpen,
  onClose,
  onBeginSetup,
  onMaybeLater,
}: AnalyticsOnboardingModalProps) {
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-full p-6 mb-4 relative">
                <div className="bg-white rounded-full p-4">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-600 mt-2">Analytics active</div>
                  </div>
                </div>
                {/* Decorative stars */}
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  Get actionable insights to push deals forward and optimize your sales process
                </span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="flex-shrink-0 mt-0.5 text-blue-600 dark:text-blue-400">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  Automate deal updates and follow-ups to reduce manual tasks and increase efficiency
                </span>
              </li>
            </ul>
          </div>
