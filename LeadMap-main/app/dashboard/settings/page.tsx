    ...
    <DashboardLayout fullBleed hideHeader>
      <div className="-mt-[30px]">
        <div
          ...
          className="settings-mesh-gradient font-sans fixed top-0 bottom-0 left-0 right-0 flex flex-col bg-mesh dark:bg-dark overflow-hidden text-gray-900 dark:text-white"
        >
          <DealsNavbar />
              ...
              <div className="flex-1 bg-white dark:bg-dark/90 rounded-r-[20px] rounded-l-[0] shadow-sm border border-l-0 border-gray-200 dark:border-gray-700 flex flex-col h-full min-h-0 overflow-hidden relative">
                ...
                <div className="flex-1 min-h-0 w-full flex flex-col overflow-hidden">
                  <div
                    ...
                    className="settings-glass-panel w-full h-full rounded-lg shadow-sm overflow-hidden flex flex-col md:flex-row flex-1 min-h-0 relative border border-gray-200 dark:border-gray-700"
                  >
          {/* Top accent bar */}
          <div
            className="absolute top-0 left-0 w-full h-0.5 bg-blue-500/30 z-10 rounded-t-lg"
            aria-hidden
          />
          ...
          <aside
            ...
            className="w-full md:w-72 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 p-6 md:p-8 flex-shrink-0 bg-gray-50 dark:bg-gray-800/80"
          >
              ...
              {NAV_ITEMS.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 group font-medium w-full text-left text-sm ${
                      isActive
            ...
            >
              {activeTab === 'account' && (
                <>
                  <div
                    ...
                    className="flex items-center gap-8 mb-10 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm"
                  >
                    <div className="relative group">
                      <div className="p-1 rounded-full border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm">
                        {avatarUrl ? (
                          <img
                            src={avatarUrl}
                            alt=""
                          ...
                          <div
                            className="w-24 h-24 rounded-full flex items-center justify-center text-3xl font-bold bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="settings-input-glass block w-full rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/20 sm:text-sm py-3 px-4 text-gray-900 dark:text-white placeholder-gray-400 font-medium"
                        />
                      </div>
                      <div className="space-y-2">
                        <label
                        ...
                        <div className="relative rounded-md shadow-sm group">
                          <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
                            <Icon
                              ...
                              className="w-5 h-5 text-gray-400 group-focus-within:text-[#3B82F6] transition-colors"
                              aria-hidden
                            />
                          </div>
                          <input
                            ...
                            data-settings="input-glass"
                            className="settings-input-glass block w-full rounded-lg border border-gray-200 dark:border-gray-700 pl-11 focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/20 sm:text-sm py-3 text-gray-900 dark:text-white placeholder-gray-400 font-medium"
                          />
                        </div>
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="md:col-span-2 space-y-2">
                        ...
                        <div className="relative">
                          <textarea
                            ...
                            data-settings="input-glass"
                            className="settings-input-glass block w-full rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/20 sm:text-sm py-3 px-4 text-gray-900 dark:text-white placeholder-gray-400 font-medium resize-none"
                          />
                          <span className="absolute bottom-3 right-3 text-xs text-gray-400 dark:text-gray-500 font-medium bg-white/50 dark:bg-gray-800/50 px-2 py-0.5 rounded-full">
                            {bioLeft} left
                          </span>
                        </div>
                      </div>
              ...
              {activeTab === 'integrations' && (
                <div className="space-y-6">
                  <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm backdrop-blur-sm">
                    <p className="text-sm text-gray-600 dark:text-gray-400 font-medium mb-4">
                  ...
                  <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm backdrop-blur-sm">
                    <div className="flex items-center gap-3 mb-2">
                      <Zap className="w-6 h-6 text-gray-700 dark:text-gray-300" aria-hidden />
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                        Webhooks
                      </h3>
                    </div>
