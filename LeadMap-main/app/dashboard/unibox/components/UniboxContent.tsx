        ...
        <header className="p-6 pb-4 border-b border-[#F3F4F6]">
                ...
                className={`size-9 rounded-full flex items-center justify-center shadow-sm border transition-colors ${
                  selectionModeVisible
                    ? selectedThreadIds.size >= threads.length &&
                      ...
                      : "bg-[#0071e3]/10 border-[#0071e3]/30 text-[#0071e3]"
                    : "bg-white border-slate-100 text-slate-600 hover:text-[#0071e3]"
                }`}
                aria-label={
                  !selectionModeVisible
          ...
          <div className="relative pt-4 mt-4 border-t border-[#F3F4F6]">
            ...
            <input
              ...
              className="w-full bg-slate-100/50 border border-[#F3F4F6] rounded-lg py-2.5 pl-10 text-sm focus:ring-1 focus:ring-[#0071e3]/20 placeholder:text-slate-400"
              aria-label="Search emails"
            />
          </div>
        </header>
        {selectedThreadIds.size > 0 && (
          <div className="flex items-center justify-between gap-3 px-4 py-2 border-b border-white/20 bg-[#0071e3]/10 shrink-0">
