      ...
      <nav className="flex flex-col gap-1">
        {onCompose && (
          <button
            type="button"
            onClick={onCompose}
            className="flex items-center gap-3 w-full px-4 py-2.5 rounded-lg transition-all duration-200 border-b border-[#F3F4F6] text-[#0071e3] hover:bg-[#0071e3]/10 font-medium"
          >
