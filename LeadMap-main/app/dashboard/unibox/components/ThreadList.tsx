    ...
    <div className="flex-1 flex flex-col space-y-1">
      {threads.map((thread) => {
        ...
        return (
          ...
          >
            {isSelected && (
              <div className="absolute left-1 top-1/2 -translate-y-1/2 w-1 h-8 bg-[#0071e3] rounded-full" aria-hidden />
            )}
            ...
            <h4 className={`text-sm truncate mb-1 ${isSelected ? 'font-medium text-[#0071e3]' : 'font-normal text-slate-900'}`}>
