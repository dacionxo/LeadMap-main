    ...
    <div className="flex-1 flex flex-col space-y-1">
      {threads.map((thread) => {
        ...
        return (
          ...
          >
            {isSelected && (
              <div className="absolute left-1 top-1/2 -translate-y-1/2 w-1 h-8 bg-[#0693ff] rounded-full" aria-hidden />
            )}
            ...
            <div className="flex-1 min-w-0">
              ...
              <h4 className={`text-sm truncate mb-1 ${isSelected ? 'font-medium text-[#0693ff]' : 'font-normal text-slate-900'}`}>
