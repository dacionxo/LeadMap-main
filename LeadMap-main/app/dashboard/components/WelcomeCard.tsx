...
function TypingAnimationMotion() {
  const words = ['back!', 'to your dashboard!']
...
export const WelcomeCard = () => {
  ...
  return (
    <div className="p-6 border-0 bg-lightprimary dark:bg-lightprimary overflow-hidden h-full relative">
      <div className="grid grid-cols-12 h-full">
        ...
        <div className="md:col-span-5 md:block hidden relative">
          {/* Placeholder for animation - can be replaced with Lottie if needed */}
          <div className="absolute right-5 -bottom-10">
            <div className="w-64 h-64 flex items-center justify-center">
              <Icon icon="solar:graph-up-bold-duotone" className="w-48 h-48 text-primary opacity-20" />
            </div>
          </div>
        </div>
      </div>
