...
export default function AppLinks() {
  return (
    <div className="dropdown-wrapper group relative">
      ...
      <span className="xl:hidden text-[#64748B] dark:text-slate-400 flex rounded-full p-2 justify-center items-center cursor-pointer hover:text-primary hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
