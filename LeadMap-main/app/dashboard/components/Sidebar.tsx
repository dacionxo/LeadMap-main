...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-40 flex h-screen flex-col border-r border-[#e5e5e5] bg-[#FFFFFF] dark:bg-dark shadow-sm transition-[width] duration-200 ease-in group ${
        isOpen
          ? "w-[270px]"
