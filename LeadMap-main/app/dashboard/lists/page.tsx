...
function ListsPageContent() {
  ...
  const [newListType, setNewListType] = useState<"people" | "properties">(
    "properties"
  );
  ...
  return (
    <div className="-mt-[30px]" data-page="dashboard-lists">
              ...
              <header className="shrink-0 z-20 px-8 py-6">
                <div className="flex items-end justify-between mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <span className="material-symbols-outlined text-[18px] text-gray-400 dark:text-slate-400">
                        upload_file
                      </span>
                      Import
                    </button>
              ...
              <main className="flex-1 overflow-auto custom-scrollbar px-8 pb-8 flex flex-col min-h-0">
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-20 text-center">
                    <div className="w-32 h-32 mb-6 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center text-5xl shadow-[0_20px_50px_-12px_rgba(131,225,255,0.35)] border border-blue-200/50 dark:border-blue-800/50">
                      📋
                    </div>
                      ...
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            {sortLabel}
                            <span className="material-symbols-outlined text-[18px] text-gray-300 dark:text-slate-500">
                              expand_more
                            </span>
                          </button>
                          {showSortDropdown && (
                            <>
                              ...
                              >
                                {(
                                  ["lastModified", "name", "created"] as const
                                ).map((opt) => (
                                  <button
                                    key={opt}
                                    type="button"
