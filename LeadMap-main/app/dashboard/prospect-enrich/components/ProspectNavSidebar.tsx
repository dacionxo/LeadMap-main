...
/**
 * ProspectNavSidebar — Inline nav sidebar for the prospect-enrich page only.
 ...
 * This sidebar is NOT the global dashboard sidebar; it lives inside the
 * prospect-enrich content area and matches the table's vertical height.
 */
...
export default function ProspectNavSidebar() {
  const pathname = usePathname()
  const searchParams = useSearchParams()

  return (
    <nav
      className="w-64 flex flex-col shrink-0 overflow-y-auto no-scrollbar py-4 px-3 bg-[#F7FAFF] dark:bg-[#0f172a] border border-slate-200 dark:border-slate-700 shadow-sm sidebar-gradient-border rounded-l-[24px] relative z-20 font-display"
