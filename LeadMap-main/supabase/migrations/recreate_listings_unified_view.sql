-- Migration: Recreate listings_unified view after full_baths type change
-- Run this AFTER change_full_baths_to_numeric.sql
-- This recreates the view that was dropped during the column type migration

-- ============================================================================
-- Recreate Unified Listings View
-- ============================================================================
...
-- Drop existing view if it exists (should already be dropped, but safe to do)
