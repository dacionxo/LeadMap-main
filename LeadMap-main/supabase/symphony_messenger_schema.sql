-- ============================================================================
-- Symphony Messenger Schema
-- Message queue system inspired by Symfony Messenger
-- ============================================================================
-- This schema provides a complete message queue system for asynchronous
-- message processing, scheduled messages, and retry mechanisms.
...
-- Function to update messenger_transports updated_at
...
-- Function to update messenger_schedules updated_at
