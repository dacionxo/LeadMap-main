...
import { Brain, Database, MapPin, Play, Search, Target } from "lucide-react";
...
export default function LandingPage() {
  ...
  const [visitedTabs, setVisitedTabs] = useState<FeatureTab[]>([
    "lead-discovery",
  ]);
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#B6B2A5" }}>
                      ...
                      <div className="grid grid-cols-4 gap-8">
                              ...
                              <div className="flex items-start space-x-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Turn hours of prospecting into minutes with
                            ...
                            <div className="group cursor-pointer">
                              <div className="flex items-start space-x-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Fuel smarter selling with always-fresh
                            ...
                            <div className="group cursor-pointer">
                              <div className="flex items-start space-x-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Qualify and act on market opportunities in
                                    seconds
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="group cursor-pointer">
                              <div className="flex items-start space-x-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Capture every opportunity, accelerate every
                                    closing
                                  </p>
                                </div>
                              </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            <a
                              href="#features"
                              className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors py-1"
                            >
                              Interactive Maps
                            </a>
                            <a
                        ...
                        <div>
                          ...
                          <div className="bg-gradient-to-br from-pink-500 via-purple-500 to-green-500 rounded-xl p-6 text-white cursor-pointer hover:shadow-xl transition-all transform hover:scale-[1.02]">
                            ...
                            <p className="text-sm opacity-90 mb-4">
                              See how AI transforms your lead generation
                              workflow
                            </p>
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                style={{
                  ...
                  transition:
                    "transform 0.3s ease, background-color 0.3s ease, padding-left 0.3s ease, padding-right 0.3s ease",
                }}
              >
                  ...
                  <svg
                    ...
                    style={{
                      ...
                      transform: isHoveringLogin
                        ...
                        : "translateX(-2px)",
                      transition:
                        "width 0.3s ease, margin-left 0.3s ease, opacity 0.3s ease, transform 0.3s ease",
                    }}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                ...
                <span className="relative z-10 flex items-center">
                  ...
                  <Play
                    ...
                    style={{
                      ...
                      transition:
                        "width 0.3s ease, height 0.3s ease, margin-left 0.3s ease, opacity 0.3s ease, transform 0.3s ease",
                    }}
                  />
                </span>
                <span
              ...
              <button
                ...
                style={{
                  ...
                  transform: isHoveringSignUp
                    ? "translateY(-2px) scale(1.05)"
                    : "translateY(0) scale(1)",
                  paddingLeft: isHoveringSignUp ? "20px" : "16px",
                  paddingRight: isHoveringSignUp ? "28px" : "16px",
                  transition:
                    "transform 0.3s ease, background 0.3s ease, box-shadow 0.3s ease, padding-left 0.3s ease, padding-right 0.3s ease",
                }}
              >
                <span className="relative z-10 flex items-center">
                  Sign Up For Free
      ...
      <div className="relative z-10 mt-16 mx-4 sm:mx-6 lg:mx-8 mb-8">
        <div className="bg-neutral-light dark:bg-neutral-dark rounded-2xl sm:rounded-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_-4px_20px_rgba(0,0,0,0.3)] overflow-hidden border border-gray-200 dark:border-gray-800">
            ...
            <div className="w-full mx-auto">
              <div className="text-center">
                ...
                <p className="text-base tablet:text-lg desktop-s:text-xl text-gray-600 dark:text-gray-400 mb-10 sm:mb-12 md:mb-14 max-w-[500px] tablet:max-w-[600px] desktop-s:max-w-[700px] desktop:max-w-[800px] mx-auto leading-relaxed font-sans">
                  Access verified, high-intent leads curated for your market —
                  all in one clean, intuitive platform built for modern
                  ...
                  <form onSubmit={handleAuth} className="space-y-3">
                        ...
                        style={{
                          transform:
                            isHoveringSubmit && !loading
                              ...
                              : "scale(1)",
                          paddingLeft:
                            isHoveringSubmit && !loading ? "28px" : "24px",
                          paddingRight:
                            isHoveringSubmit && !loading ? "36px" : "24px",
                          boxShadow:
                            isHoveringSubmit && !loading
                              ? "0 10px 25px -5px rgba(59, 130, 246, 0.4), 0 0 20px rgba(147, 51, 234, 0.3)"
                              : "0 4px 6px -1px rgba(0, 0, 0, 0.1)",
                          transition:
                            "transform 0.3s ease, box-shadow 0.3s ease, padding-left 0.3s ease, padding-right 0.3s ease",
                        }}
                      >
                    ...
                    {error && (
                      <div className="p-2.5 bg-error/10 dark:bg-error/20 border border-error/30 dark:border-error/40 rounded-lg">
                        <p className="text-error dark:text-error-400 text-xs">
                          {error}
                        </p>
                      </div>
                    )}
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      >
                        ...
                        >
                          ...
                          <path
                            fill="url(#microsoft-gradient-hero)"
                ...
                <div className="flex flex-col gap-6 desktop-s:flex-row desktop-s:items-end desktop-s:gap-0">
                  <div className="flex-[2_2_0%]">
                    <h5 className="antialiased desktop-xl:text-[36px] desktop-xl:tracking-[-0.72px] desktop-xl:leading-[110%] desktop:text-[32px] desktop:tracking-[-0.64px] desktop:leading-[110%] desktop-s:text-[28px] desktop-s:tracking-[-0.56px] desktop-s:leading-[110%] tablet:text-[24px] tablet:tracking-[-0.48px] tablet:leading-[110%] text-[20px] tracking-[-0.4px] leading-[110%] font-heading font-normal text-gray-900 dark:text-white desktop-s:max-w-[520px] desktop:max-w-[650px] desktop-xl:max-w-[800px]">
                      <span className="whitespace-nowrap font-heading font-normal">
                        &ldquo;Every agent is more productive with NextDeal.
                      </span>
                      <br />
                      <span className="font-heading font-normal">
                        We closed 75% more deals while cutting prospecting time
                        in half.&rdquo;
                      </span>
                    </h5>
                  </div>
          ...
          {/* Wave Divider */}
          <div
            className="relative w-full overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.15),0_5px_20px_rgba(0,0,0,0.2)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.4),0_5px_20px_rgba(0,0,0,0.5)]"
            ...
            <div className="relative flex w-full flex-col gap-10 bg-white pt-16 desktop-s:pt-20">
              ...
              <div className="mx-auto pb-3 tablet:w-[433px] desktop:w-[629px] desktop-xl:w-[852px]">
                ...
                <p className="antialiased desktop-xl:text-[22px] desktop-xl:tracking-[-0.22px] desktop-xl:leading-[130%] desktop:text-[20px] desktop:tracking-[-0.2px] desktop:leading-[130%] desktop-s:text-[20px] desktop-s:tracking-[-0.2px] desktop-s:leading-[130%] tablet:text-[18px] tablet:tracking-[-0.18px] tablet:leading-[130%] text-[16px] tracking-[-0.16px] leading-[130%] font-sans text-gray-600 dark:text-gray-400 mt-4 text-center">
                  Powered by NextDeal — one of the largest, most accurate real
                  estate data networks on the planet.
                </p>
              </div>

              {/* Features Grid - Hidden when scrolled out of view */}
              <div
                className={`grid grid-cols-1 gap-3 tablet:grid-cols-2 desktop-s:grid-cols-4 desktop-s:gap-4 transition-opacity duration-300 ${showFeatureCards ? "opacity-100" : "opacity-0 pointer-events-none h-0 overflow-hidden"}`}
              >
                ...
                >
                  ...
                  <p className="antialiased desktop-xl:text-[13px] desktop-xl:leading-[130%] desktop:text-[12px] desktop:leading-[130%] text-[12px] leading-[130%] font-sans text-center text-gray-600 dark:text-gray-400">
                    Find high-quality property leads faster with AI-powered
                    insights and comprehensive market data.
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="antialiased desktop-xl:text-[13px] desktop-xl:leading-[130%] desktop:text-[12px] desktop:leading-[130%] text-[12px] leading-[130%] font-sans text-center text-gray-600 dark:text-gray-400">
                    Cleanse and complete your records with always-fresh property
                    and owner data that powers smarter targeting.
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="antialiased desktop-xl:text-[13px] desktop-xl:leading-[130%] desktop:text-[12px] desktop:leading-[130%] text-[12px] leading-[130%] font-sans text-center text-gray-600 dark:text-gray-400">
                    Qualify and act on market opportunities in seconds with
                ...
                >
                  ...
                  <p className="antialiased desktop-xl:text-[13px] desktop-xl:leading-[130%] desktop:text-[12px] desktop:leading-[130%] text-[12px] leading-[130%] font-sans text-center text-gray-600 dark:text-gray-400">
                    Keep deals moving with AI-powered prep, meeting insights,
          ...
          >
            <div
              ...
              style={{
                ...
                transform: isVisible["stats-item-1"]
                  ? "translateY(0)"
                  : "translateY(20px)",
            ...
            <div
              ...
              style={{
                ...
                transform: isVisible["stats-item-2"]
                  ? "translateY(0)"
                  : "translateY(20px)",
                transition:
            ...
            <div
              ...
              style={{
                ...
                transform: isVisible["stats-item-3"]
                  ? "translateY(0)"
                  : "translateY(20px)",
                transition:
          ...
          <div
            ...
            style={{ backgroundColor: "#f7faff", height: "120px" }}
          >
            <style
              dangerouslySetInnerHTML={{
                __html: `
          ...
          <div
            ...
            style={{
              ...
              transform: isVisible["faq-section"]
                ? "translateY(0)"
                : "translateY(30px)",
              transition: "opacity 0.8s ease-out, transform 0.8s ease-out",
            }}
            ...
            <div className="flex flex-col tablet:flex-row gap-8 tablet:gap-12 desktop:gap-16 max-w-7xl mx-auto">
              ...
              <div className="tablet:w-1/2 space-y-4">
                {[
                  {
                    question:
                      "Does NextDeal provide comprehensive property and ownership data?",
                    answer:
                  ...
                  {
                    question:
                      "Can NextDeal enable precise lead targeting via advanced filtering?",
                    answer:
                  ...
                  {
                    question:
                      "Does NextDeal automate outreach sequences and follow-ups?",
                    answer:
                  ...
                  {
                    question:
                      "Does NextDeal integrate smoothly with CRMs and existing real estate tools?",
                    answer:
                  ...
                  {
                    question:
                      "Does NextDeal offer analytics and reporting on lead generation performance?",
                    answer:
                  ...
                  {
                    question:
                      "Is NextDeal good value for its cost, especially for growing real estate teams?",
                    answer:
                  ...
                  {
                    question:
                      "Does NextDeal support users with helpful educational resources and onboarding?",
                    answer:
                      "Yes, NextDeal provides comprehensive onboarding, training resources, and ongoing support to help you get the most out of the platform from day one.",
                  },
                  {
                    question:
                      "Can NextDeal help reduce time spent on manual prospecting?",
                    answer:
                  ...
                  {
                    question:
                      "Does NextDeal improve the quality of sales pipelines?",
                    answer:
                  ...
                  {
                    question:
                      "Can NextDeal scale with a business as real estate needs grow?",
                    answer:
                      "NextDeal is built to scale with your business. Whether you're a solo agent or a large team, our flexible platform grows with you and your changing needs.",
                  },
                ].map((faq, index) => (
                  <details
                    key={index}
          ...
          <div className="flex justify-between desktop-xl:gap-[244px] desktop-xl:p-24 desktop:gap-[133px] desktop:py-24 desktop:px-20 desktop-s:flex-row desktop-s:gap-20 desktop-s:py-24 desktop-s:px-16 tablet:gap-20 tablet:py-16 tablet:px-12 flex-col gap-12 py-12 px-5 w-full max-w-[1440px]">
            ...
            <div className="flex flex-col gap-6 desktop-s:w-1/4">
              ...
              <nav className="flex flex-col gap-3">
                <a
                  href="/privacy"
                  className="text-sm font-light text-black hover:text-black transition-colors"
                >
                  Privacy Policy
                </a>
                <a
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-sm font-heading font-semibold text-black uppercase tracking-wider">
                Product
              </h4>
              <nav className="flex flex-col gap-3">
                <a
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-[1440px] px-5 tablet:px-12 desktop-s:px-16 desktop:px-20 desktop-xl:px-24">
              <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                © {new Date().getFullYear()} Galapagos Digital LLC. All rights
                reserved.
              </p>
            </div>
          </div>
